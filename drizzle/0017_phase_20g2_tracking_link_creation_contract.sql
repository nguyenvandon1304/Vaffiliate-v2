/*
 * Extend the tracking-link creation contract for manual Shopee Affiliate
 * provisioning.
 *
 * network_sub_id is the stable Sub_id1 assigned to the tracking link.
 * affiliate_url remains nullable until the server-only provisioning flow
 * verifies and stores a Shopee-generated affiliate URL.
 */
...
CREATE FUNCTION public.create_cashback_tracking_link(
  p_platform text,
