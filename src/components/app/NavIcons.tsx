...
import type { NavItemId } from "./primaryNav";
...
function LinkIcon({ className }: NavIconProps) {
  return (
    <svg
      width="20"
      height="20"
...
function WalletIcon({ className }: NavIconProps) {
  return (
    <svg
      width="20"
      height="20"
...
function MoreIcon({ className }: NavIconProps) {
  return (
    <svg
      width="20"
      height="20"
...
function CampaignIcon({ className }: NavIconProps) {
  return (
    <svg
      width="20"
      height="20"
...
function PointerIcon({ className }: NavIconProps) {
  return (
    <svg
      width="20"
      height="20"
      ...
      className={className}
    >
      <path d="m5 3 14 9-6 1-3 6Z" />
      <path d="m13 13 5 5" />
    </svg>
  );
}

function ConversionIcon({ className }: NavIconProps) {
  return (
    <svg
      width="20"
      height="20"
...
function RevenueIcon({ className }: NavIconProps) {
  return (
    <svg
      width="20"
      height="20"
...
> = {
  ...
  offers: TagIcon,
  "tracking-links": LinkIcon,
  clicks: PointerIcon,
  conversions: ConversionIcon,
