  ...
  return (
    <main className="min-h-screen px-4 py-5 sm:px-6 sm:py-8">
      <div className="page-shell">
        <section className="grid gap-4 lg:grid-cols-[0.95fr_1.05fr] lg:items-stretch lg:gap-6">
          <div className="relative overflow-hidden rounded-[calc(var(--radius-2xl)+0.25rem)] border border-[color:var(--line)] bg-[linear-gradient(180deg,rgba(255,250,246,0.94),rgba(250,242,235,0.94))] p-5 shadow-[var(--shadow-lg)] sm:p-8 lg:p-10">
            <div className="pointer-events-none absolute inset-0">
              <div className="absolute -left-12 top-10 h-36 w-36 rounded-full bg-[rgba(216,138,82,0.16)] blur-3xl" />
              <div className="absolute right-0 top-0 h-48 w-48 rounded-full bg-[rgba(124,63,44,0.1)] blur-3xl" />
            </div>
          ...
          <div className="surface-card bg-[rgba(255,252,249,0.9)] p-6 sm:p-8 lg:p-10">
            ...
            {errorMessage ? (
              <div
                role="alert"
                aria-live="polite"
                className="mb-5 rounded-[var(--radius-lg)] border border-[rgba(180,70,70,0.24)] bg-[rgba(180,70,70,0.08)] px-4 py-3 text-sm font-medium text-red-700"
              >
                {errorMessage}
              </div>
            ) : null}
            ...
            {successMessage ? (
              <div
                role="status"
                aria-live="polite"
                className="mb-5 rounded-[var(--radius-lg)] border border-[rgba(47,143,97,0.2)] bg-[rgba(47,143,97,0.1)] px-4 py-3 text-sm font-medium text-[color:var(--success)]"
              >
                {successMessage}
              </div>
            ) : null}
