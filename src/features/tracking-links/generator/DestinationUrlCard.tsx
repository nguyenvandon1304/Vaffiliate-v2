...
export default function DestinationUrlCard({ destinationUrl }: Props) {
  return (
    <div className="rounded-[var(--radius-xl)] border border-[color:var(--line)] bg-[rgba(255,252,249,0.88)] p-5 shadow-[var(--shadow-sm)]">
      <p className="text-sm font-medium text-[color:var(--text-muted)]">Destination URL</p>
      ...
      <p className="mt-3 text-sm leading-6 text-[color:var(--text-muted)]">
        Trang đích sẽ tự động gắn tracking link khi người dùng truy cập. Bạn không cần chỉnh sửa URL gốc.
      </p>
    </div>
  );
}
